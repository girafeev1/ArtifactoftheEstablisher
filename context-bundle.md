...
- **Head (source)**: `79fdce73e769ab9d877a1559e37c56159c6a49f4`
...
```txt
 .github/workflows/pr-diff-file.yml          |  17 +-
 ...
 16 files changed, 1964 insertions(+), 79 deletions(-)
```
...
-  contents: write
-  pull-requests: write
+  contents: write        # to commit the diff file on same-repo PRs
...
+          # Record the current (post-commit) SHA so the snapshot always points to the commit that contains the file
...
+  })
+})
diff --git a/docs/context/PR-212.md b/docs/context/PR-212.md
new file mode 100644
index 0000000..29eb6f9
--- /dev/null
+++ b/docs/context/PR-212.md
@@ -0,0 +1,764 @@
+# PR #212 — Diff Summary
+
+- **Base (target)**: `6fbfe13d4d75daf00d1a533fa98c8283443e57d6`
