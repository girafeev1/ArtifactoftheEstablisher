...
- **Head (source)**: `a136354917f2d1bb12409309e04ca72c8bb1db48`
...
```txt
 ...
 context-bundle.md                          | 1302 ---------
 docs/context/PR-224.md                     | 4085 ++++++++++++++++++++++++++++
 ...
 9 files changed, 4404 insertions(+), 1312 deletions(-)
```
...
-```
diff --git a/docs/context/PR-224.md b/docs/context/PR-224.md
new file mode 100644
index 0000000..8671206
--- /dev/null
+++ b/docs/context/PR-224.md
@@ -0,0 +1,4085 @@
+# PR #224 — Diff Summary
+
+- **Base (target)**: `abee6b8d1306f3136abef093fe0b787abefaa11e`
