...
- **Head (source)**: `7341543415150bedc1f27c14fb80f062ed2661d4`
...
```txt
 ...
 pages/dashboard/new-ui/client-accounts.tsx         | 1129 ++++++++--
 scripts/replaceImportMetaLoader.js                 |   13 +
 styles/antd-reset.css                              |  257 +++
 14 files changed, 4113 insertions(+), 333 deletions(-)
```
...
@@ -44,35 +294,22 @@ const refineDataProvider: DataProvider = {
     }
