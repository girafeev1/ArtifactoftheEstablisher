...
- **Head (source)**: `6f5b9d4bda3277ba01f25766ab2a3f41108171a7`
...
```txt
 ...
 pages/api/client-directory/index.ts                |    6 +
 ...
 14 files changed, 3948 insertions(+), 315 deletions(-)
```
...
index 35c04e9..629f84d 100644
--- a/lib/firebase.ts
+++ b/lib/firebase.ts
@@ -9,19 +9,66 @@ const firebaseConfig = {
...
+  }
+}
diff --git a/pages/api/client-directory/index.ts b/pages/api/client-directory/index.ts
index a352835..0c0fd1d 100644
--- a/pages/api/client-directory/index.ts
+++ b/pages/api/client-directory/index.ts
