...
- **Head (source)**: `ebe749c007a86d70d2f8f831764ebfe547c7cbda`
...
```txt
 ...
 components/StudentDialog/PaymentDetail.tsx         | 193 +++++++++++++++++----
...
@@ -191,6 +227,36 @@ export default function PaymentDetail({
     )
   }
...
+            }
             if (sessionOrds.length) {
               ...
               fields.push({
@@ -414,22 +541,6 @@ export default function PaymentDetail({
                 ),
               })
             }
-            fields.push({
