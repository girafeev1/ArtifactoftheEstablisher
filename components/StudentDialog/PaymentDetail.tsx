...
export default function PaymentDetail({
  ...
  const assignedSessions = rows.filter((r) => assignedSet.has(r.id))
  const available = rows.filter((r) => !assignedSet.has(r.id))
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      const newAssigned = [...(payment.assignedSessions || []), ...selected]
